...
function Login(props){
  ...
  const loginEvent = () =>{
    ...
    .catch(error =>{
      ...
      alert("There is Error from Server, Please contact Administrator : 070-4327-7702\n", error.data);
    });
  ...
  class Enter_evnet extends Component {
      ...
      <div className="flex items-center justify-center min-h-screen bg-opacity-50">
        ...
        <div className="max-w-md w-full z-10 flex flex-col items-center justify-center">
          ...
          <form>
            ...
            <button type="button" id="LOGIN" className="w-full py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white rounded-md focus:outline-none focus:bg-blue-700" onClick={loginEvent}>Log In</button>
